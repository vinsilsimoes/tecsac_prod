    ...
    <div>
      <div class="form-row justify-content-center">
        <div class="form-group col-md-6">
          ...
          <input type="number" class="form-control"  placeholder="WhatsApp" value={this.state.campWhatsApp} onChange={(value)=> this.setState({campWhatsApp:value.target.value})}/>
        </div>
        <div class="form-group col-md-6">
          <label for="inputEmail4">Usuário</label>
          <input type="number" class="form-control"  placeholder="Usuário" value={this.state.campUser} onChange={(value)=> this.setState({campUser:value.target.value})}/>
        </div>
      </div>
