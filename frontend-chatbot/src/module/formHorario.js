    ...
    <div>
      <div class="form-row justify-content-center">
        <div class="form-group col-md-6">
          ...
          <input type="time" class="form-control"  placeholder="Início" value={this.state.campInicio} onChange={(value)=> this.setState({campInicio:value.target.value})}/>
        </div>
        <div class="form-group col-md-6">
          <label for="inputEmail4">Término</label>
          <input type="time" class="form-control"  placeholder="Término" value={this.state.campTermino} onChange={(value)=> this.setState({campTermino:value.target.value})}/>
        </div>
      </div>
