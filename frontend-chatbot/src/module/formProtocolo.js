    ...
    <div>
      <div class="form-row justify-content-center">
        <div class="form-group col-md-6">
          ...
          <input type="text" class="form-control"  placeholder="16535419865156" value={this.state.campProtocolo} onChange={(value)=> this.setState({campProtocolo:value.target.value})}/>
        </div>
        <div class="form-group col-md-6">
          <label for="inputEmail4">Usuário</label>
          <input type="text" class="form-control"  placeholder="5535988754197" value={this.state.campUsuario} onChange={(value)=> this.setState({campUsuario:value.target.value})}/>
        </div>
      </div>
