      ...
      <div>
        <div class="form-row justify-content-center">
          <div class="form-group col-md-6">
            ...
            <input type="time" class="form-control"  placeholder="Início"
          ...
          <div class="form-group col-md-6">
            ...
            <input type="time" class="form-control"  placeholder="Término"
        ...
        {'   '}
        <button type="submit" class="btn btn-primary" onClick={()=>this.handleClick()}>Listar Horários</button>
      </div>
    );
  }
